...
public class WrappingTrinketsUtils {
    ...
    public static Optional<SlotReference> createTrinketsReference(io.wispforest.accessories.api.slot.SlotReference slotReference, boolean allowAlternativeHand){
        try {
            ...
            var slotType = SlotTypeLoader.getSlotType(slotReference.entity().getWorld(), container.getSlotName());
    ...
    public static SlotGroup getGroup(World level, String accessoriesSlot) {
    ...
    public static Identifier trinketsToAccessories_Validators(Identifier location) {
