...
public abstract class HandledScreenMixin {
    ...
    private void adjustSlotRender(DrawContext instance, int x, int y, int blitOffset, int width, int height, Sprite sprite, Operation<Void> original, @Local(argsOnly = true) Slot slot, @Local(ordinal = 0) Pair<Identifier, Identifier> pair) {
